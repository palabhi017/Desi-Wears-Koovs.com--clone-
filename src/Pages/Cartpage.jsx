...
const deletecartdata = async(id)=>{
  try {
     await axios.delete(`https://eager-handkerchief-bass.cyclic.app/cart/delete/${id}`)
   getcartdata(userId)  
  } catch (error) {
    console.log(error)
  }
...
try {
  await axios.patch(`https://eager-handkerchief-bass.cyclic.app/cart/update/${orderId}`,{quantity:num})
  getcartdata(userId)
